        ...
        <View style={styles.content}>
          ...
          <View style={styles.priceSection}>
            ...
            <Text style={styles.priceText}>
              {item?.priceFrom ? `${formatINR(item?.priceFrom)} +` : null}
...
const BuilderFeaturedProperties = () => {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryFn: builderServices.getBuilderFeaturedProperties,
...
export default BuilderFeaturedProperties;
